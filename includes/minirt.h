...
typedef int			(*t_intersect_fnct)
	(double *closest, t_ray *ray, void *elem_detail);
typedef void		(*t_change_fnct)
	(void *elem_detail, int key, t_info *info);
...
int					intersect_nothing(double *closest,
	t_ray *ray, void *elem_detail);
int					intersect_plane(double *closest,
	t_ray *ray, void *elem_detail);
int					intersect_square(double *closest,
	t_ray *ray, void *elem_detail);
int					intersect_sphere(double *closest,
	t_ray *ray, void *elem_detail);
int					intersect_triangle(double *closest,
	t_ray *ray, void *elem_detail);
void				intersect_arr_init();
void				print_vec3lf(t_vec3lf vec);
t_elem_list			*find_closest(t_ray *ray,
	t_info *info, double closest, int i);
double				plane_dist(double closest,
	t_ray *ray, t_vec3lf *plane_normal, t_vec3lf o);
...
t_vec3lf			rotate(t_vec3lf v,
	t_camera *camera, int key, t_info *info);
